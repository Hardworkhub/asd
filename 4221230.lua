local HardworkLib = loadstring([[
do
    local HardworkLib = game:GetService("CoreGui"):FindFirstChild("Hardwork [Atomic Lib]")
    if HardworkLib then
        HardworkLib:Destroy()
    end
end
...
Atomlib.Name = "Hardwork [Atomic Lib]"
...
function ems:DropDown(text,text2,list,callback)
    ...
    TextLabelDrop.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
    ...
    FrameDrop.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
    ...
    TextLabelDrop2.TextColor3 = Color3.fromRGB(0, 255, 255)
    ...
    TextButton_Dropdown.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
...
--------------------------------------_G----------------------------------
_G.Noclip = false
_G.TeleportEnable = false
_G.FastAttack = false
_G.Bypassed = nil
--------------------------------------------------------------------------

local Win = HardworkLib:Win()
local Tab1 = Win:addtap("Main")
local Tab2 = Win:addtap("Teleport")
local Tab3 = Win:addtap("Misc")
...
Page1:Toggle("Toggle", nil, function(boolean)
    print(boolean)
end)

Page1:Ti("Auto Farm")

Page1:Toggle("Auto Farm", nil, function(boolean)
    print(boolean)
end)
...
Page2:DropDown("Title", "Selected", {"Table Info"}, function(tabl)
    print("Selected "..tostring(tabl))
end)

local Min = 1
local Max = 100
local Base = 50
Page2:Slder("Title", Min, Max, Base, function(int)
    print("Slidded to "..tostring(int))
end)
...
Page3:Button("Teleport To First World", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    Page3:Button("Teleport To Second World", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    Page3:Button("Teleport To Third World", function()
...
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
        pcall(function ()
            if _G.Noclip then
                game.Players.LocalPlayer.Character.Humanoid:SetStateEnabled(11,false)
            end

            if _G.Noclip then
                game.Players.LocalPlayer.Character.Humanoid:SetStateEnabled(11,true)
            end
        end)
    end)
end)
...
function Teleport:TP(P1)
    ...
    twer = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart,TweenInfo.new(Distance/Speed, Enum.EasingStyle.Linear),
        {CFrame = P1}):Play()
    _G.Noclip = true
    wait(Distance/Speed)

    if _G.TeleportEnable then
...
function BypassTP(C1)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = C1
end

getgenv().autobypass = nil
function iv()
	pcall(function ()
		...
		while task.wait() do
			if getgenv().autobypass then
				if _G.Bypassed == nil then
					game.Players.LocalPlayer.Character.Humanoid:SetStateEnabled(15, false)
					if world1 then
						EnMob = Enemies:FindFirstChild("Military Spy [Lv. 330]")
						RepMob = Rep:FindFirstChild("Military Spy [Lv. 330]")
					elseif world2 then
						EnMob = Enemies:FindFirstChild("Marine Captain [Lv. 900]")
						RepMob = Rep:FindFirstChild("Marine Captain [Lv. 900]")
					elseif world3 then
						EnMob = Enemies:FindFirstChild("Marine Commodore [Lv. 1700]")
						RepMob = Rep:FindFirstChild("Marine Commodore [Lv. 1700]")
					end
					...
					if game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
						repeat task.wait()
							BypassTP(Mob.HumanoidRootPart.CFrame * CFrame.new(0, 0, -3))
						until
							not getgenv().autobypass or not _G.Bypassed == false or game.Players.LocalPlayer.Character.Humanoid.Health <= 0
					else
...
function BypassDisibled()
        game.Players.LocalPlayer.Character.Humanoid:SetStateEnabled(15,true);
        game.Players.LocalPlayer.Character.Humanoid:SetStateEnabled(16,true);
...
----------------------------- Normal TP --------------------------------------------------
if world1 then
    Page3:Button("Start Island",function()
        Teleport:TP(CFrame.new(1071.2832, 16.3085976, 1426.86792))
    end)
    Page3:Button("Marine Start",function()
        Teleport:TP(CFrame.new(-2573.3374, 6.88881969, 2046.99817))
    end)
    Page3:Button("Middle Town",function()
        Teleport:TP(CFrame.new(-655.824158, 7.88708115, 1436.67908))
    end)
    Page3:Button("Jungle",function()
        Teleport:TP(CFrame.new(-1249.77222, 11.8870859, 341.356476))
    end)
    Page3:Button("Pirate Village",function()
        Teleport:TP(CFrame.new(-1122.34998, 4.78708982, 3855.91992))
    end)
    Page3:Button("Desert",function()
        Teleport:TP(CFrame.new(1094.14587, 6.47350502, 4192.88721))
    end)
    Page3:Button("Frozen Village",function()
        Teleport:TP(CFrame.new(1198.00928, 27.0074959, -1211.73376))
    end)
    Page3:Button("MarineFord",function()
        Teleport:TP(CFrame.new(-4505.375, 20.687294, 4260.55908))
    end)
    Page3:Button("Colosseum",function()
        Teleport:TP(CFrame.new(-1428.35474, 7.38933945, -3014.37305))
    end)
    Page3:Button("Sky island 1 ",function()
        Teleport:TP(CFrame.new(-4970.21875, 717.707275, -2622.35449))
    end)
    Page3:Button("Sky island 2 ",function()
        Teleport:TP(CFrame.new(-4813.0249, 903.708557, -1912.69055))
    end)
    Page3:Button("Sky island 3 ",function()
        Teleport:TP(CFrame.new(-7952.31006, 5545.52832, -320.704956))
    end)
    Page3:Button("Sky island 4 ",function()
        Teleport:TP(CFrame.new(-7793.43896, 5607.22168, -2016.58362))
    end)
    Page3:Button("Prison",function()
        Teleport:TP(CFrame.new(4854.16455, 5.68742752, 740.194641))
    end)
    Page3:Button("Magma Village",function()
        Teleport:TP(CFrame.new(-5231.75879, 8.61593437, 8467.87695))
    end)
    Page3:Button("UndeyWater City",function()
        Teleport:TP(CFrame.new(61163.8516, 11.7796879, 1819.78418))
    end)
    Page3:Button("Fountain City",function()
        Teleport:TP(CFrame.new(5132.7124, 4.53632832, 4037.8562))
    end)
    Page3:Button("House Cyborg's",function()
        Teleport:TP(CFrame.new(6262.72559, 71.3003616, 3998.23047))
    end)
    Page3:Button("Shank's Room",function()
        Teleport:TP(CFrame.new(-1442.16553, 29.8788261, -28.3547478))
    end)
    Page3:Button("Mob Island",function()
        Teleport:TP(CFrame.new(-2850.20068, 7.39224768, 5354.99268))
    end)
end
if world2 then
    Page3:Button("Dock",function()
        Teleport:TP(CFrame.new(82.9490662, 18.0710983, 2834.98779))
    end)
    Page3:Button("Kingdom of Rose",function()
        Teleport:TP(CFrame.new(-394.983521, 118.503128, 1245.8446))
    end)
    Page3:Button("Mansion",function()
        Teleport:TP(CFrame.new(-390.096313, 331.886475, 673.464966))
    end)
    Page3:Button("Flamingo Room",function()
        Teleport:TP(CFrame.new(2302.19019, 15.1778421, 663.811035))
    end)
    Page3:Button("Green Zone",function()
        Teleport:TP(CFrame.new(-2372.14697, 72.9919434, -3166.51416))
    end)
    Page3:Button("Cafe",function()
        Teleport:TP(CFrame.new(-385.250916, 73.0458984, 297.388397))
    end)
    Page3:Button("Factroy",function()
        Teleport:TP(CFrame.new(430.42569, 210.019623, -432.504791))
    end)
    Page3:Button("Colosseum",function()
        Teleport:TP(CFrame.new(-1836.58191, 44.5890656, 1360.30652))
    end)
    Page3:Button("Grave Island",function()
        Teleport:TP(CFrame.new(-5411.47607, 48.8234024, -721.272522))
    end)
    Page3:Button("Snow Mountain",function()
        Teleport:TP(CFrame.new(511.825226, 401.765198, -5380.396))
    end)
    Page3:Button("Cold Island",function()
        Teleport:TP(CFrame.new(-6026.96484, 14.7461271, -5071.96338))
    end)
    Page3:Button("Hot Island",function()
        Teleport:TP(CFrame.new(-5478.39209, 15.9775667, -5246.9126))
    end)
    Page3:Button("Cursed Ship",function()
        Teleport:TP(CFrame.new(902.059143, 124.752518, 33071.8125))
    end)
    Page3:Button("Ice Castle",function()
        Teleport:TP(CFrame.new(5400.40381, 28.21698, -6236.99219))
    end)
    Page3:Button("Forgotten Island",function()
        Teleport:TP(CFrame.new(-3043.31543, 238.881271, -10191.5791))
    end)
    Page3:Button("Usoapp Island",function()
        Teleport:TP(CFrame.new(4748.78857, 8.35370827, 2849.57959))
    end)
    Page3:Button("Minisky Island",function()
        Teleport:TP(CFrame.new(-260.358917, 49325.7031, -35259.3008))
    end)
end
if world3 then
    Page3:Button("Port Towen",function()
    Teleport:TP(CFrame.new(-610.309692, 57.8323097, 6436.33594))
end)
Page3:Button("Hydra Island",function()
    Teleport:TP(CFrame.new(5229.99561, 603.916565, 345.154022))
end)
Page3:Button("Great Tree",function()
    Teleport:TP(CFrame.new(2174.94873, 28.7312393, -6728.83154))
end)
Page3:Button("Castle on the Sea",function()
    Teleport:TP(CFrame.new(-5477.62842, 313.794739, -2808.4585))
end)
Page3:Button("Floating Turtle",function()
    Teleport:TP(CFrame.new(-10919.2998, 331.788452, -8637.57227))
end)
Page3:Button("Mansion",function()
    Teleport:TP(CFrame.new(-12553.8125, 332.403961, -7621.91748))
end)
Page3:Button("Secret Temple",function()
    Teleport:TP(CFrame.new(5217.35693, 6.56511116, 1100.88159))
end)
Page3:Button("Friendly Arena",function()
    Teleport:TP(CFrame.new(5220.28955, 72.8193436, -1450.86304))
end)
Page3:Button("Beautiful Pirate Domain",function()
    Teleport:TP(CFrame.new(5310.8095703125, 21.594484329224, 129.39053344727))
end)
Page3:Button("Teler Park",function()
    Teleport:TP(CFrame.new(-9512.3623046875, 142.13258361816, 5548.845703125))
end)
Page3:Button("Ice Cream Island",function()
    Teleport:TP(CFrame.new(-900.67767333984, 58.971530914307, -10871.236328125))
end)
Page3:Button("Peanut Island",function()
    Teleport:TP(CFrame.new(-2045.2473144531, 4.701087474823, -9899.9716796875))
end)

end

---------------------------- Bypass TP ---------------------------------------------------
Page4:Ti("ByPass Teleport")

_G.TeleportStat = nil
Page4:Button("ByPass Teleport", function()
    BypassEnabled()
    _G.TeleportStat = true
end)
Page4:Button("stop", function()
    BypassDisibled()
	_G.Bypassed = nil
    _G.TeleportStat = false
end)
...
if world1 then
    Page4:Button("Start Island",function()
        BypassTP(CFrame.new(1071.2832, 16.3085976, 1426.86792))
    end)
    Page4:Button("Marine Start",function()
        BypassTP(CFrame.new(-2573.3374, 6.88881969, 2046.99817))
    end)
    Page4:Button("Middle Town",function()
        BypassTP(CFrame.new(-655.824158, 7.88708115, 1436.67908))
    end)
    Page4:Button("Jungle",function()
        BypassTP(CFrame.new(-1249.77222, 11.8870859, 341.356476))
    end)
    Page4:Button("Pirate Village",function()
        BypassTP(CFrame.new(-1122.34998, 4.78708982, 3855.91992))
    end)
    Page4:Button("Desert",function()
        BypassTP(CFrame.new(1094.14587, 6.47350502, 4192.88721))
    end)
    Page4:Button("Frozen Village",function()
        BypassTP(CFrame.new(1198.00928, 27.0074959, -1211.73376))
    end)
    Page4:Button("MarineFord",function()
        BypassTP(CFrame.new(-4505.375, 20.687294, 4260.55908))
    end)
    Page4:Button("Colosseum",function()
        BypassTP(CFrame.new(-1428.35474, 7.38933945, -3014.37305))
    end)
    Page4:Button("Sky island 1 ",function()
        BypassTP(CFrame.new(-4970.21875, 717.707275, -2622.35449))
    end)
    Page4:Button("Sky island 2 ",function()
        BypassTP(CFrame.new(-4813.0249, 903.708557, -1912.69055))
    end)
    Page4:Button("Sky island 3 ",function()
        BypassTP(CFrame.new(-7952.31006, 5545.52832, -320.704956))
    end)
    Page4:Button("Sky island 4 ",function()
        BypassTP(CFrame.new(-7793.43896, 5607.22168, -2016.58362))
    end)
    Page4:Button("Prison",function()
        BypassTP(CFrame.new(4854.16455, 5.68742752, 740.194641))
    end)
    Page4:Button("Magma Village",function()
        BypassTP(CFrame.new(-5231.75879, 8.61593437, 8467.87695))
    end)
    Page4:Button("UndeyWater City",function()
        BypassTP(CFrame.new(61163.8516, 11.7796879, 1819.78418))
    end)
    Page4:Button("Fountain City",function()
        BypassTP(CFrame.new(5132.7124, 4.53632832, 4037.8562))
    end)
    Page4:Button("House Cyborg's",function()
        BypassTP(CFrame.new(6262.72559, 71.3003616, 3998.23047))
    end)
...
if world2 then
    Page4:Button("Dock",function()
        BypassTP(CFrame.new(82.9490662, 18.0710983, 2834.98779))
    end)
    Page4:Button("Kingdom of Rose",function()
        BypassTP(CFrame.new(-394.983521, 118.503128, 1245.8446))
    end)
    Page4:Button("Mansion",function()
        BypassTP(CFrame.new(-390.096313, 331.886475, 673.464966))
    end)
    Page4:Button("Flamingo Room",function()
        BypassTP(CFrame.new(2302.19019, 15.1778421, 663.811035))
    end)
    Page4:Button("Green Zone",function()
        BypassTP(CFrame.new(-2372.14697, 72.9919434, -3166.51416))
    end)
    Page4:Button("Cafe",function()
        BypassTP(CFrame.new(-385.250916, 73.0458984, 297.388397))
    end)
    Page4:Button("Factroy",function()
        BypassTP(CFrame.new(430.42569, 210.019623, -432.504791))
    end)
    Page4:Button("Colosseum",function()
        BypassTP(CFrame.new(-1836.58191, 44.5890656, 1360.30652))
    end)
    Page4:Button("Grave Island",function()
        BypassTP(CFrame.new(-5411.47607, 48.8234024, -721.272522))
    end)
    Page4:Button("Snow Mountain",function()
        BypassTP(CFrame.new(511.825226, 401.765198, -5380.396))
    end)
    Page4:Button("Cold Island",function()
        BypassTP(CFrame.new(-6026.96484, 14.7461271, -5071.96338))
    end)
    Page4:Button("Hot Island",function()
        BypassTP(CFrame.new(-5478.39209, 15.9775667, -5246.9126))
    end)
    Page4:Button("Cursed Ship",function()
        BypassTP(CFrame.new(902.059143, 124.752518, 33071.8125))
    end)
    Page4:Button("Ice Castle",function()
        BypassTP(CFrame.new(5400.40381, 28.21698, -6236.99219))
    end)
    Page4:Button("Forgotten Island",function()
        BypassTP(CFrame.new(-3043.31543, 238.881271, -10191.5791))
    end)
    Page4:Button("Usoapp Island",function()
        BypassTP(CFrame.new(4748.78857, 8.35370827, 2849.57959))
    end)
    Page4:Button("Minisky Island",function()
        BypassTP(CFrame.new(-260.358917, 49325.7031, -35259.3008))
    end)
end
if world3 then
    Page4:Button("Port Towen",function()
    BypassTP(CFrame.new(-610.309692, 57.8323097, 6436.33594))
end)
Page4:Button("Hydra Island",function()
    BypassTP(CFrame.new(5229.99561, 603.916565, 345.154022))
end)
Page4:Button("Great Tree",function()
    BypassTP(CFrame.new(2174.94873, 28.7312393, -6728.83154))
end)
Page4:Button("Castle on the Sea",function()
    BypassTP(CFrame.new(-5477.62842, 313.794739, -2808.4585))
end)
Page4:Button("Floating Turtle",function()
    BypassTP(CFrame.new(-10919.2998, 331.788452, -8637.57227))
end)
Page4:Button("Mansion",function()
    BypassTP(CFrame.new(-12553.8125, 332.403961, -7621.91748))
end)
Page4:Button("Secret Temple",function()
    BypassTP(CFrame.new(5217.35693, 6.56511116, 1100.88159))
end)
Page4:Button("Friendly Arena",function()
    BypassTP(CFrame.new(5220.28955, 72.8193436, -1450.86304))
end)
Page4:Button("Beautiful Pirate Domain",function()
    BypassTP(CFrame.new(5310.8095703125, 21.594484329224, 129.39053344727))
end)
Page4:Button("Teler Park",function()
    BypassTP(CFrame.new(-9512.3623046875, 142.13258361816, 5548.845703125))
end)
Page4:Button("Ice Cream Island",function()
    BypassTP(CFrame.new(-900.67767333984, 58.971530914307, -10871.236328125))
end)
Page4:Button("Peanut Island",function()
    BypassTP(CFrame.new(-2045.2473144531, 4.701087474823, -9899.9716796875))
end)

end

-------------------------------------------------Misc-------------------------------------------------
local Page5 = Tab3:addpage()
...
if world1 then
    table.insert(IslandCFrame,CFrame.new(0,0,0))
elseif world2 then
    table.insert(IslandCFrame,CFrame.new(0,0,0))
elseif world3 then
    table.insert(IslandCFrame,CFrame.new(-610.309692, 57.8323097, 6436.33594))
    table.insert(IslandCFrame,CFrame.new(5229.99561, 603.916565, 345.154022))
    table.insert(IslandCFrame,CFrame.new(2174.94873, 28.7312393, -6728.83154))
    table.insert(IslandCFrame,CFrame.new(-5477.62842, 313.794739, -2808.4585))
    table.insert(IslandCFrame,CFrame.new(-10919.2998, 331.788452, -8637.57227))
    table.insert(IslandCFrame,CFrame.new(-12553.8125, 332.403961, -7621.91748))
    table.insert(IslandCFrame,CFrame.new(5217.35693, 6.56511116, 1100.88159))
    table.insert(IslandCFrame,CFrame.new(5220.28955, 72.8193436, -1450.86304))
    table.insert(IslandCFrame,CFrame.new(5310.8095703125, 21.594484329224, 129.39053344727))
    table.insert(IslandCFrame,CFrame.new(-9512.3623046875, 142.13258361816, 5548.845703125))
    table.insert(IslandCFrame,CFrame.new(-900.67767333984, 58.971530914307, -10871.236328125))
    table.insert(IslandCFrame,CFrame.new(-2045.2473144531, 4.701087474823, -9899.9716796875))
end

if world1 then
    table.insert(IslandName,"Starter Island")
elseif world2 then
    table.insert(IslandName,"First Island")
elseif world3 then
    table.insert(IslandName,"Port Towen")
    table.insert(IslandName,"Hydra Island")
    table.insert(IslandName,"Great Tree")
    table.insert(IslandName,"Castle on the Sea")
    table.insert(IslandName,"Floating Turtle")
    table.insert(IslandName,"Mansion")
    table.insert(IslandName,"Secret Temple")
    table.insert(IslandName,"Friendly Arena")
    table.insert(IslandName,"Beautiful Pirate Domain")
    table.insert(IslandName,"Teler Park")
    table.insert(IslandName,"Ice Cream Island")
    table.insert(IslandName,"Peanut Island")

end

local TeleportStat =  Page5:Label("Teleport Stat | Tween")
    if _G.TeleportStat then
    TeleportStat:Change("Teleport Stat |".." Bypass Teleport")
    end
    if  _G.TeleportStat then
    TeleportStat:Change("Teleport Stat |".." Tween")
    end


Page5:DropDown("Teleport", "Selected", IslandName, function(v)
  SelectedIsland = v
  spawn(function()
        pcall(function()
        while task.wait() do
            ...
            elseif world3 then
            if v == IslandName[1] then
                Teleport:TP(IslandCFrame[1])
            elseif v == IslandName[2] then
                Teleport:TP(IslandCFrame[2])
            elseif v == IslandName[3] then
                Teleport:TP(IslandCFrame[3])
            elseif v == IslandName[4] then
                Teleport:TP(IslandCFrame[4])
            elseif v == IslandName[5] then
                Teleport:TP(IslandCFrame[5])
            elseif v == IslandName[6] then
                Teleport:TP(IslandCFrame[6])
            elseif v == IslandName[7] then
                Teleport:TP(IslandCFrame[7])
            elseif v == IslandName[8] then
                Teleport:TP(IslandCFrame[8])
            elseif v == IslandName[9] then
                Teleport:TP(IslandCFrame[9])
            elseif v == IslandName[10] then
                Teleport:TP(IslandCFrame[10])
            elseif v == IslandName[11] then
                Teleport:TP(IslandCFrame[11])
            elseif v == IslandName[12] then
                Teleport:TP(IslandCFrame[12])
            end
...
Page5:Toggle("Teleport", _G.TeleportEnable, function(x)
    _G.TeleportEnable = x
end)
